...
// Background effects layer for arcade pages:
//   - Floating four-point sparkle particles on a fixed canvas
//   - Click-anywhere confetti burst at the click point (skipping interactive
//     elements that have their own micro-feedback)
...
export function LandingFX() {
  ...
  useEffect(() => {
    const onClick = (e: MouseEvent) => {
      ...
      if (tgt.closest("nav, .marquee-strip, footer, .arcade-no-confetti, a, button, input, textarea, label, select"))
        return;
  ...
  return <canvas ref={cvRef} aria-hidden className="fixed inset-0 pointer-events-none z-[1]" />;
}
