      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-3.5 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-1 sm:gap-2">
          ...
          <Link
            ref={ctaRef}
            href="/"
            className="cta-magnetic ml-2 px-5 py-2.5 rounded-full bg-ink text-paper font-display text-[13px] leading-none relative"
            style={{
            ...
            onMouseEnter={(e) => {
              ...
              t.style.boxShadow = "6px 6px 0 var(--cherry)";
            }}
            onMouseLeave={(e) => {
              const t = e.currentTarget as HTMLAnchorElement;
              t.style.boxShadow = "4px 4px 0 var(--cherry)";
            }}
          >
            SCORE ME
            <span
              className="absolute inset-[-4px] rounded-full pointer-events-none animate-cta-pulse"
            />
          </Link>
        </nav>
      </div>
