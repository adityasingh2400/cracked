  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // light-mode palette automatically. HoloCard is exempt — it styles
        // itself inline because a trading card looks like a trading card on
        // any background.
        white: "#3C1F15",
        black: "#FFF6EC",
        ...
        // `cream` stays light. It's used in two roles:
        //   - bg-cream / border-cream → light card surface on the arcade page
        //   - text-cream inside HoloCard → light text on the card's dark interior
        // Both contexts want a warm-light color, so cream maps to the paper
        // cream tone and varies its tint values for legacy /45, /60, /90 usage.
        cream: {
          DEFAULT: "#FFFAF2",
          dim: "#F5EBD9",
          muted: "#E7D5BC",
        ...
        // Holo card foil palette — preserved verbatim
        foil: {
          violet: "#8B5CF6",
          pink: "#EC4899",
          cyan: "#06B6D4",
